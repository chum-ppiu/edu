...
const teachers = ref([
  { initials: 'DR', fullName: 'Mr. Dara Ros', subject: 'Mathematics · Grade 10, 11, 12', color: 'linear-gradient(135deg,#4f8ef7,#7c5cfc)', status: 'Active', classes: 3, students: 92, rating: 4.8 },
  { initials: 'SP', fullName: 'Ms. Sreypich Pok', subject: 'English · Grade 10, 11', color: 'linear-gradient(135deg,#00d4aa,#4f8ef7)', status: 'Active', classes: 2, students: 64, rating: 4.9 },
  { initials: 'KM', fullName: 'Mr. Kosal Mao', subject: 'Science · Grade 11, 12', color: 'linear-gradient(135deg,#f7934f,#f75f5f)', status: 'On Leave', classes: 2, students: 58, rating: 4.6 },
])
...
<template>
  <div class="page active">
    ...
    <div class="grid-3">
      <div v-for="teacher in teachers" :key="teacher.fullName" class="card">
        <div class="card-body" style="text-align:center;padding:24px;">
          ...
          <div style="font-weight:700;font-size:15px;margin-bottom:4px;">{{ teacher.fullName }}</div>
